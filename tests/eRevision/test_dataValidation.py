...
@pytest.mark.parametrize("param,value,code,description,id",
                         [
                             ...
                             pytest.param("action", "checkItems", "DR-3/21",
                                          ...
                                          " Expected values: 'getAmendmentIds, dataValidation, createAmendment, CheckAccessToAmendment', actual value: 'checkItems'.",
                                          uuid4(),
                                          marks=pytestrail.case('C8136')),
                             pytest.param("action", "", "DR-3/21",
                                          "Attribute value mismatch of 'action' with one of enum expected values."
                                          " Expected values: 'getAmendmentIds, dataValidation, createAmendment, CheckAccessToAmendment', actual value: ''.",
                                          uuid4(),
